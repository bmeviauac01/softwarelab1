...
!!! info "Segítség a POST kéréshez"
    A POST kérés elküldéséhez segítséget például a hivatalos Microsoft tutorial [vonatkozó részében](https://docs.microsoft.com/en-us/aspnet/core/tutorials/first-web-api?view=aspnetcore-3.1&tabs=visual-studio#examine-the-posttodoitem-create-method) találsz.
